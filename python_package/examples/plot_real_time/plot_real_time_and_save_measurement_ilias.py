...
class Graph:
    ...
    def new_measurement(self, patientname, recording_minutes=10, technician="", recording_additional="",
...
if __name__ == '__main__':
    ...
    try:
        ...
        #while board_shim.get_board_data_count() < 250: #ensures that all data shape is the same
        #    time.sleep(0.005)

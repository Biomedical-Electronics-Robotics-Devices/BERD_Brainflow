...
enum class GeenieCommandTypes : int
{
...
protected:
    ...
    int apply_single_command (std::string command)
    {
        ...
        {
            return (int)GeenieCommandTypes::NOT_CHANNEL_COMMAND;
        }
        ...
        {
            return (int)GeenieCommandTypes::INVALID_COMMAND;
        }
        // input type check
        ...
        return (int)GeenieCommandTypes::VALID_COMMAND;
    }
...
public:
    ...
    virtual int apply_config (std::string config)
    {
        ...
        int res = (int)GeenieCommandTypes::NOT_CHANNEL_COMMAND;
